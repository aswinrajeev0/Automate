...
export default function WorkshopResetPasswordPage() {
    ...
    const resetPassword = useWorkshopResetPassword()
            ...
            <div className="flex min-h-screen items-center justify-center bg-gray-100">
                <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-md">
                    ...
                    <Link
                        ...
                        className="block w-full rounded-md bg-black p-3 text-center font-semibold text-red-400 hover:bg-gray-900"
                    >
            ...
            <div className="w-full md:w-1/2 bg-white p-8 flex flex-col justify-center">
                <div className="max-w-md mx-auto w-full">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <div className="mt-2">
                            <Link to="/landing" className="text-red-600 hover:text-red-800 text-sm">
                    ...
                    <div className="flex items-center mb-6">
                        <Link to="/workshop/login" className="flex items-center text-gray-600 hover:text-red-600 transition-colors">
                        ...
                        {({ }) => (
                            <Form className="space-y-4">
                                ...
                                <button
                                    type="submit"
                                    disabled={isLoading}
                                    className="w-full h-12 bg-black text-red-400 font-semibold rounded-md hover:bg-gray-900 transition-colors mt-6"
                                >
