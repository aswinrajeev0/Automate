...
export default function WokshopForgotPasswordPage() {
    ...
    const sendOtp = useWorkshopResetPasswordOtp();
    ...
    const handleVerifyOtp = async (otp: string) => {
        ...
        try {
            ...
            if (otpResponse) {
                setTimeout(() => {
                    navigate(`/workshop/reset-password?token=${resetToken}`);
                }, 2000);
            }
        } catch (error: any) {
            toast({
        ...
        <div className="flex min-h-screen">
            ...
            <div className="w-full md:w-1/2 bg-red-100 p-8 flex flex-col justify-center">
                <div className="max-w-md mx-auto w-full">
                    ...
                    <h1 className="text-3xl font-bold mb-2">Workshop Forgot Password</h1>
