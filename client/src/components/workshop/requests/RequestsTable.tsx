                    ...
                    {requests.map((request, index) => (
                        <tr key={request.requestId} className={index % 2 === 0 ? "bg-gray-50" : "bg-white"}>
                            ...
                            <td className="px-4 py-3 whitespace-nowrap text-sm font-medium">
                                <button onClick={() => navigate(`/workshop/requests/request-details/${request.requestId}`)} className="text-blue-600 hover:text-blue-800 cursor-pointer flex items-center gap-1">
                                    <Eye size={16} />
                                    View
                                </button>
                            </td>
