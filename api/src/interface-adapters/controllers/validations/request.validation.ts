...
import { carBrandSchema, carTypeSchema, descriptionSchema, locationSchema, noteSchema, typeSchema, vehicleNumberSchema } from "../../../shared/validations/request.validation";
